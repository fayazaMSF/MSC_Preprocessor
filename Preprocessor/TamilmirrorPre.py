...
date_var = "03122018"
path = os.path.join('C:\\Users\\ffayaza\\Documents\\MscProject\\Data\\December\\%s\\Tamilmirror.xml' % date_var)
tree = ET.parse(path)
root = tree.getroot()
# base dir
...
file_dir = os.path.join(_dir, 'Tamilmirror_%s.xml' % date_var)
file = open(file_dir,"w", encoding="utf-8")
# path = "C:\\Users\\ffayaza\\Documents\\MscProject\\Data\\1Week\\16102018\\Tamilmirror.xml"
# tree = ET.parse(path)
# root = tree.getroot()
#
# file = open("C:\\Users\\ffayaza\\Documents\\MscProject\\Data\\PreProcessData\\16102018\\Tamilmirror_16102018.xml", "w", encoding="utf-8")
...
for item in iterator:
    ...
    # 2018 ஒக்டோபர் 31
    # 2018 நவம்பர் 30
    if "2018 டிசெம்பர் 03" not in date_text:
