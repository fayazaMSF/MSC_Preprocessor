...
import os
#
# path = "C:\\Users\\ffayaza\\Documents\\MscProject\\Data\\1Week\\16102018\\Adaderana.xml"
# tree = ET.parse(path)
# root = tree.getroot()
#
# file = open("C:\\Users\\ffayaza\\Documents\\MscProject\\Data\\PreProcessData\\16102018\\Adaderana_16102018.xml", "w", encoding="utf-8")
date_var = "15122018"
path = os.path.join('C:\\Users\\ffayaza\\Documents\\MscProject\\Data\\\December\\%s\\Adaderana.xml' % date_var)
tree = ET.parse(path)
root = tree.getroot()
# base dir
...
file_dir = os.path.join(_dir, 'Adaderana_%s.xml' % date_var)
...
for item in iterator:
    ...
    # October 31, 2018
    # November 18, 2018
    if "December 15, 2018" not in date_text:
...
# tree.write("DuplicateRemovedThinakaran.xml", encoding="utf-8")
