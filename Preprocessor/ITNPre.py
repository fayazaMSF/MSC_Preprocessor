...
date_var = "03122018"
path = os.path.join('C:\\Users\\ffayaza\\Documents\\MscProject\\Data\\\December\\%s\\ITN.xml' % date_var)
tree = ET.parse(path)
root = tree.getroot()
# base dir
...
file_dir = os.path.join(_dir, 'ITN_%s.xml' % date_var)
...
for item in iterator:
    ...
    # 31.அக் 2018
    # 30.நவ் 2018
    if "3.டிசம்பர் 2018" not in date_text:
