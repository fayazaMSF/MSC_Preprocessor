...
path = 'C:\\Users\\ffayaza\\Documents\\MscProject\\ModelData\\ITN\\2018-09-17T09-25-10.xml'
tree = ET.parse(path)
root = tree.getroot()

file_dir = "C:\\Users\\ffayaza\\Documents\\MscProject\\ModelData\\ITN\\ITN_M.xml"
file_dir_model = "C:\\Users\\ffayaza\\Documents\\MscProject\\ModelData\\ITN\\ITN_Model.txt"
title_dir = "C:\\Users\\ffayaza\\Documents\\MscProject\\ModelData\\ITN\\ITN_title.txt"
body_dir = "C:\\Users\\ffayaza\\Documents\\MscProject\\ModelData\\ITN\\ITN_body.txt"
...
for item in iterator:
    ...
    body = item.find('BODY')
    body_text = body.text
    date = item.find('DATE').findall("value")[1]
    date_text = date.text
...
for item in root:
    ...
    # item_date = item.find('DATE').findall("value")[1].text
    # print(item_url)
    print(item_title)
    print(item_body)
    # print(item_date)
    ...
    # file.write("<DATE>"+str(item_date.strip()[7:19]) +"</DATE>"+ "\n")
    file.write("</NEWS> "+"\n")
    file.write("\n")
